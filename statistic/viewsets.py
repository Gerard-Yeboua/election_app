...
from statistic.filters import CacheStatistiqueFilter, StatistiqueTimelineFilter
from statistic.permissions import CanManageCache, CanRefreshCache, CanViewStatistics
from statistic.serializers import BureauVoteSerializer, CacheStatistiqueSerializer, ComparaisonRegionsSerializer, SnapshotQuotidienSerializer, StatistiqueBureauSerializer, StatistiqueCandidatSerializer, StatistiquePerformanceSerializer, StatistiqueRegionSerializer, StatistiqueTimelineSerializer, StatsRegionDetailSerializer
...
from statistic.permissions import *
